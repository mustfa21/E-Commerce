...
<head>
	...
	<title>@yield('title',' الرئيسية |') زول شوب  </title>
...
<body class="home-page home-01 " >
	<style>
		...
		li.menu-item .nav-label.sale-label::before{
			border-top-color:  #4bba78;
			border-left-color:  #4bba78;
		}
